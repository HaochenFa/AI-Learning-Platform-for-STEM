...
\midrule
Authentication & Email/password sign-in for permanent accounts, a shared \texttt{AuthSurface} for sign-in/sign-up/forgot-password, landing-page modal auth via query params, fallback pages at \texttt{/login}, \texttt{/register}, and \texttt{/forgot-password}, SSR confirmation/recovery handling via \texttt{/auth/confirm}, dedicated \texttt{/reset-password} completion, and guest access via Supabase Anonymous Auth. \\
