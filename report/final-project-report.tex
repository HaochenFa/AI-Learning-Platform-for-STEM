...
{\large \bfseries Group Member Placeholders \par}
\vspace{0.35cm}
\begin{tabularx}{0.9\textwidth}{>{\bfseries}p{2.2cm}X X}
\toprule
Slot & Name & Student ID \\
\midrule
Member 1 & [Name Placeholder] & [Student ID Placeholder] \\
Member 2 & [Name Placeholder] & [Student ID Placeholder] \\
Member 3 & [Name Placeholder] & [Student ID Placeholder] \\
Member 4 & [Name Placeholder] & [Student ID Placeholder] \\
\bottomrule
\end{tabularx}
\vfill
{\large
